...
final class BondsService
{
    ...
    private function transformBond(array $data): Bond
    {
        ...
        try {
            return new Bond(
                ...
                minPriceIncrement: isset($data['minPriceIncrement'])
                    ? Quotation::fromApi($data['minPriceIncrement'])
                    : new Quotation("0", 0),
                ...
                tradingStatus: isset($data['tradingStatus'])
                    ? SecurityTradingStatus::fromApi($data['tradingStatus'])
                    : null,
                ...
                first1minCandleDate: isset($data['first1minCandleDate'])
                    ? new DateTimeImmutable($data['first1minCandleDate'])
                    : null,
                first1dayCandleDate: isset($data['first1dayCandleDate'])
                    ? new DateTimeImmutable($data['first1dayCandleDate'])
                    : null,
    ...
    private function transformBondEvent(array $data): BondEvent
    {
        ...
        return new BondEvent(
            ...
            couponInterestRate: isset($data['couponInterestRate'])
                ? Quotation::fromApi($data['couponInterestRate'])
                : null
        );
    }
}
